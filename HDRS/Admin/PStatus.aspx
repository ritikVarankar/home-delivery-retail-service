<%@ Page Language="C#" MasterPageFile="~/Admin/Default.master" AutoEventWireup="true" CodeBehind="PStatus.aspx.cs" Inherits="HDRS.Admin.PStatus" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div id="div2" align="center" style="background-color: #99CCFF">
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" Visible="False" EmptyDataText="Enter Correct OrderID">
            <Columns>
